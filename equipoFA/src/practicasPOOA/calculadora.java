...
public class calculadora extends JFrame {
	...
	public calculadora() {
		...
		btnSiete.setFont(new Font("Arial", Font.BOLD, 20));
		...
		btnOcho.setFont(new Font("Arial", Font.BOLD, 20));
		...
		btnNueve.setFont(new Font("Arial", Font.BOLD, 20));
		...
		btnCuatro.setFont(new Font("Arial", Font.BOLD, 20));
		...
		btnCinco.setFont(new Font("Arial", Font.BOLD, 20));
		...
		btnSeis.setFont(new Font("Arial", Font.BOLD, 20));
		...
		btnDos.setFont(new Font("Arial", Font.BOLD, 20));
		...
		btnTres.setFont(new Font("Arial", Font.BOLD, 20));
		...
		btnCero.setFont(new Font("Arial", Font.BOLD, 20));
		...
		btnDivision.setFont(new Font("Arial", Font.BOLD, 20));
		...
		btnMultiplicacion.setFont(new Font("Arial", Font.BOLD, 20));
		...
		btnResta.setFont(new Font("Arial", Font.BOLD, 20));
		...
		btnCuadrado.setFont(new Font("Arial", Font.BOLD, 20));
		...
		btnSuma.setFont(new Font("Arial", Font.BOLD, 20));
		panel_1.add(btnSuma);
		...
		btnSigno.setFont(new Font("Arial", Font.BOLD, 20));
